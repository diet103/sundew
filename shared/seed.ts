            ...
            },
            {
                ...
                questions: [
                    ...
                    },
                    {
                        ...
                        type: 'longText',
                        title: 'Field notes',
                        description: 'Rules can compare values too: this appears once the rating hits 4. Try moving it above the rating (section list, or Alt+Arrow) to see a broken thread.',
                        required: false,
                        visibleWhen: { mode: 'all', rules: [{ when: qid(7), operator: 'atLeast', value: '4' }] },
                    },
                ],
            },
        ],
